...
dst_base="/inspire/hdd/global_user/hezhengfu-240208120186/rlin_projects/rlin_projects/chess-SAEs-N/result_BT4/tc/k_30_e_16"
mkdir -p "$dst_base"
...
LOGDIR="$(pwd)/logs/analyze_tc/k_30_exp_16"
mkdir -p "$LOGDIR"
