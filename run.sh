...
uv run lm-saes create dataset chess_full_puzzle_demo /inspire/hdd/global_user/hezhengfu-240208120186/data/rlin_data/Chess/chess_compilation_data/dataset_info.json
