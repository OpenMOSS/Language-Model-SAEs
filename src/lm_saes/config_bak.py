...
class SAEConfig(BaseSAEConfig):
    ...
    use_auxk: bool = False  # Whether to use auxiliary loss for topk activation function
...
class LanguageModelConfig(BaseModelConfig):
    ...
    """ Number of transformer layers. If None, will be inferred from model. """
    n_heads: Optional[int] = None
    """ Number of attention heads. If None, will be inferred from model. """
    n_ctx: Optional[int] = None
    """ Context length. If None, will be inferred from model. """
    act_fn: Optional[str] = None
    """ Activation function. If None, will use default. """
    normalization_type: Optional[str] = None
    """ Normalization type. If None, will use default. """
    use_custom_weight_conversion: bool = False
    """ Whether to use custom weight conversion for local checkpoint files. """
    weight_conversion_function: Optional[str] = None
    """ Name of the weight conversion function to use. """
