...
# Invert dictionaries. We already have the wn and bn ones but less error-prone to just
# recompute them all.
_idx_to_uci_wn = {idx: uci for uci, idx in _uci_to_idx_wn.items()}
_idx_to_uci_bn = {idx: uci for uci, idx in _uci_to_idx_bn.items()}
_idx_to_uci_wc = {idx: uci for uci, idx in _uci_to_idx_wc.items()}
_idx_to_uci_bc = {idx: uci for uci, idx in _uci_to_idx_bc.items()}

idx_to_uci = [_idx_to_uci_wn, _idx_to_uci_wc, _idx_to_uci_bn, _idx_to_uci_bc]
