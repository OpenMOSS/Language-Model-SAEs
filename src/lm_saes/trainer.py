    ...
    def _initialize_optimizer(self, sae: AbstractSparseAutoEncoder):
        ...
        if self.cfg.optimizer_type == "adam":
            ...
            optimizer = LazyAdam(
                ...
                betas=self.cfg.betas,
                weight_decay=self.cfg.weight_decay,
                update_param_on_zero_grad=self.cfg.update_param_on_zero_grad,
                update_exp_avg_on_zero_grad=self.cfg.update_exp_avg_on_zero_grad,
                update_exp_avg_sq_on_zero_grad=self.cfg.update_exp_avg_sq_on_zero_grad,
            )
        else:
