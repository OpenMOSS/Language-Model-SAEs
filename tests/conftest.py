...
def pytest_addoption(parser):
    ...
    # FIXME remove default model path
    parser.addoption('--model_path', type=str, required=False, default="/remote-home/share/models/llama3_hf/Meta-Llama-3-8B", help='Hugging-face model path used to load.')
