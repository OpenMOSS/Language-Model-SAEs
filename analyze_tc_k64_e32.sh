...
dst_base="/inspire/hdd/global_user/hezhengfu-240208120186/rlin_projects/rlin_projects/chess-SAEs-N/result_BT4/tc/k_64_e_32"
mkdir -p "$dst_base"

for i in $(seq 0 14); do
    src="${src_base}/lc0_L${i}M_32x_k64_lr8e-04_auxk_sparseadam"
...
for i in $(seq 0 14); do
    old="${dst_base}/lc0_L${i}M_32x_k64_lr8e-04_auxk_sparseadam"
    new="${dst_base}/L${i}"
...
LOGDIR="$(pwd)/logs/analyze_tc/k_64_exp_32"
mkdir -p "$LOGDIR"
