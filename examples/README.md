...
To launch experiments with cached activations, you should first generate activations with 1d shape (`(batch, d_model)`, for training use), and 2d shape (`(batch, n_context, d_model)`, for analyzing use), by running [generate_pythia_activation_1d](https://github.com/OpenMOSS/Llamascopium/blob/main/examples/generate_pythia_activation_1d.py) and [generate_pythia_activation_2d](https://github.com/OpenMOSS/Llamascopium/blob/main/examples/generate_pythia_activation_2d.py). Then, you can use [train_pythia_sae_with_pre_generated_activations](https://github.com/OpenMOSS/Llamascopium/blob/main/examples/train_pythia_sae_with_pre_generated_activations.py) and [analyze_pythia_sae_with_pre_generated_activations](https://github.com/OpenMOSS/Llamascopium/blob/main/examples/analyze_pythia_sae_with_pre_generated_activations.py) to run training and analyzing respectively, with a pre-generated activation path specified. Note the analyzing still requires a MongoDB instance running.