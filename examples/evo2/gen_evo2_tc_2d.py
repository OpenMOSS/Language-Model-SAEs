...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate Evo2 transcoder activations (2D).")
    ...
    parser.add_argument("--output-dir", type=str, default=str(default_activation_dir("tc_2d")))
