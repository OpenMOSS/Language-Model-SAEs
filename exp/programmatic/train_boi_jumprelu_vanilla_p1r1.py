...
if __name__ == "__main__":
    ...
    settings = TrainSAESettings(
        ...
        trainer=TrainerConfig(
            ...
            exp_result_path=f"/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/JR_CC_tests_shared/vanilla/{subject_model}_l{l}_{expfactor}x_lr{lr}_jumprelu_l1coef{l1_coefficient}_p1r1_fulltokens",
        ),
        wandb=WandbConfig(
            log_to_wandb=True,
            wandb_project="boi-sweep",
            exp_name=f"vanilla_{subject_model}_l{l}_{expfactor}x_lr{lr}_jumprelu_l1coef{l1_coefficient}_p1r1_fulltokens",
        ),
