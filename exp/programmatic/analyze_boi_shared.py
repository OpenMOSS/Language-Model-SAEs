...
cc_path = f"/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/JR_CC_tests_shared/shared/{subject_model}_l{l}_{expfactor}x_lr{lr}_jumprelu_l1coef{l1_coefficient}_shared_decoder_sparsity_factor{shared_decoder_sparsity_factor}_p1r1_fulltokens"
...
if __name__ == "__main__":
    settings = AnalyzeSAESettings(
        ...
        analyzer=FeatureAnalyzerConfig(
            ...
            subsamples={
                "top_activations": {"proportion": 1.0, "n_samples": 12},
                "top_80_percent": {"proportion": 0.8, "n_samples": 2},
                "top_50_percent": {"proportion": 0.5, "n_samples": 2},
            },
        ),
        sae_name=f"BIO-{subject_model}-l{l}-shared-p1r1-l1{l1_coefficient}",
        ...
        mongo=MongoDBConfig(mongo_uri="mongodb://10.244.84.103:27017/", mongodb="mechinterp"),
    )
