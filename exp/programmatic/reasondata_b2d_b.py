...
if __name__ == "__main__":
    ...
    settings = GenerateActivationsSettings(
        ...
        dataset=DatasetConfig(
            dataset_name_or_path="/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/diff_datas/OpenR1-Math-220k-b",
            is_dataset_on_disk=True,
        ),
        dataset_name="OpenR1-Math-220k-b",
        hook_points=["blocks.15.hook_resid_post"],
        output_dir="/inspire/hdd/global_user/hezhengfu-240208120186/jiaxing_activations/reasondata-b-2d-801M",
