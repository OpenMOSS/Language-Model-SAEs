...
if __name__ == "__main__":
    path_dict = {
        0: "/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/gen_act/b-2d",
        1: "/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/gen_act/i-2d",
        2: "/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/gen_act/o-2d",
    }
    ...
    settings = TrainSAESettings(
        ...
        trainer=TrainerConfig(
            ...
            exp_result_path=f"/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/zfhe/jiaxing_projects/Language-Model-SAEs/exp/JR_CC_tests_shared_contra/{subject_model}_l{l}_{expfactor}x_lr{lr}_jumprelu_l1coef{l1_coefficient}_shared_decoder_sparsity_factor{args.shared_decoder_sparsity_factor}",
        ),
        wandb=WandbConfig(
            log_to_wandb=True,
            wandb_project="boi-sweep",
            exp_name=f"zf_{subject_model}_l{l}_{expfactor}x_lr{lr}_jumprelu_l1coef{l1_coefficient}_shared_decoder_sparsity_factor{args.shared_decoder_sparsity_factor}",
        ),
