...
if __name__ == "__main__":
    ...
    exp_result_path = os.path.expanduser(f"~/xy_projects/Language-Model-SAEs/results/pythia-{args.size}/{name}")


if __name__ == "__main__":
    exp_result_path = os.path.expanduser("~/xy_projects/Language-Model-SAEs/results/pythia-sae")
            ...
            sources=[
                ActivationFactoryActivationsSource(
                    path=os.path.expanduser(
                        f"/inspire/hdd/project/embodied-multimodality/public/zfhe/activations/SlimPajama-3B-activations-pythia-{args.size}-1d-all-fp16/{args.step}"
                    ),
                    sample_weights=1.0,
                    name=args.step,
                    device="cuda",
