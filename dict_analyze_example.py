...
file_names = ['L5A-l1-0.00012-lr-0.001-32x', 'L0A-l1-0.00012-lr-0.001-32x', 'L0M-l1-0.00012-lr-0.001-32x',
              ...
              'L10A-l1-0.00012-lr-0.001-32x', 'L10M-l1-0.0cd ..0012-lr-0.001-32x',
...
for file_name in file_names:
    cfg = FeaturesDecoderConfig(
        **SAEConfig.get_hyperparameters(file_name, '/remote-home/share/research/mechinterp/gpt2-dictionary/results', 'pruned.pt'),
        ...
        top = 10,
        dict_name=file_name,
        db_url='mongodb://10.176.58.101:27777',
        db_name='mechinterp'
        )
