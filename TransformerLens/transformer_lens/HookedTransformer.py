...
The Hooked Transformer is the core part of transformer_lens.

In common PyTorch model implementations (e.g. ones from HuggingFace) it's fairly easy to extract
model weights, but much harder to extract activations. transformer_lens aims to simplify this task by
...
class HookedTransformer(HookedRootModule):
    ...
    transformer_lens comes loaded with >50 GPT-style models. Typically you initialise it with one of
    ...
    def _init_weights_xavier(self, dist_type="normal"):
        ...
        Note that since transformer_lens implements the matrices in the opposite orientation to what
